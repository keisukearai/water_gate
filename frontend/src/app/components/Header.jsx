  ...
  return (
    <header>
      <div className="z-20 w-full relative">
        <div className="fixed top-0 left-0 flex h-20 w-full text-header-text-color border-b-2 border-neutral-300 bg-gradient-to-r from-neutral-700 to-neutral-500">
          {/* ハンバーガーメニューボタン */}
