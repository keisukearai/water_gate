# Generated by Django 4.2.5 on 2024-01-14 06:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_device_gateaddress', models.CharField(max_length=256, verbose_name='扉住所')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(auto_now_add=True, verbose_name='作成日時')),
                ('gw_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.gateway', verbose_name='ゲートウェイ')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gate_status', models.CharField(max_length=1, verbose_name='ゲート状態')),
                ('create_date', models.DateTimeField(auto_now_add=True, verbose_name='作成日時')),
                ('update_date', models.DateTimeField(auto_now=True, verbose_name='更新日時')),
                ('dev_eui', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.enddevice', verbose_name='エンドデバイスID')),
            ],
            options={
