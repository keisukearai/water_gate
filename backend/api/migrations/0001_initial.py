# Generated by Django 4.2.5 on 2024-03-08 22:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_disp', models.BooleanField(default=True, verbose_name='画面有無')),
                ('create_date', models.DateTimeField(auto_now_add=True, verbose_name='作成日時')),
                ('update_date', models.DateTimeField(auto_now=True, verbose_name='更新日時')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_disp', models.BooleanField(default=True, verbose_name='画面表示')),
                ('create_date', models.DateTimeField(auto_now_add=True, verbose_name='作成日時')),
                ('update_date', models.DateTimeField(auto_now=True, verbose_name='更新日時')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('battery_level', models.CharField(blank=True, max_length=1, null=True, verbose_name='電池残量')),
                ('com_status', models.CharField(blank=True, max_length=1, null=True, verbose_name='通信状況')),
